...
const Home = () => {
	...
	return (
		<>
			{data && (
				<Grid size="lg" number={12} direction="column" className="container container__home">
					...
					/>
					<Grid size="lg" number={12} direction="column" className="margin__xs__top"></Grid>
					<Button
						type="button"
						variant="outlined"
					...
					/>
					<Grid size="lg" number={12} direction="column" className="container__link">
